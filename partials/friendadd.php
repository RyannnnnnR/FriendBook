        ...
        <div class="shadow-md h-full">
            <div class="p-6">
                <div class="flex  justify-between">
                    <div class="">
                        <h4 class="text-gray-400 inline">Joe Rogan <span class="bg-blue-200 inline-flex justify-between rounded-full px-2 text-xs text-blue-900 ml-2 leading-5 font-semibold">5<span class="font-normal ml-1"> Mutual Friends</span></span></h4>
        ...
        <div class="shadow-md h-full">
            <div class="p-6">
                <div class="flex  justify-between">
                    ...
                    <div>
                        <img src="http://api.adorable.io/avatars/285/abbot1.png" alt="" class="rounded-full h-12 w-12">
                    </div>
                </div>
            </div>
            <div class="text-center border-t border-gray-500 text-gray-500 hover:text-gray-400">
        ...
        <div class="shadow-md h-full">
            <div class="p-6">
                <div class="flex  justify-between">
                    ...
                    <div>
                        <img src="http://api.adorable.io/avatars/285/abbot2.png" alt="" class="rounded-full h-12 w-12">
                    </div>
                </div>
            </div>
            <div class="text-center border-t border-gray-500 text-gray-500 hover:text-gray-400">
